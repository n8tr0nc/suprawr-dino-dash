      ...
      <aside className="dashboard-sidebar">
        <div className="sidebar-top">
          <div className="sidebar-brand">
            <img src="/suprawr001.webp" alt="SUPRAWR" className="sidebar-brand-logo" />
          ...
          <div className="sidebar-section">
            ...
            <ul className="sidebar-modules-list">
              ...
              <li className="sidebar-module">
                ...
                <span className="sidebar-module-badge sidebar-module-badge--soon">Dev</span>
              </li>
              <li className="sidebar-module">
        ...
        <div className="sidebar-version">
          v0.1.0 – Built by the Suprawr Crew.<br />
        ...
        <header className="dashboard-header">
          <div>
            <h1 className="dashboard-title">
              <span className="gas-icon" role="img" aria-label="Gas icon">⛽︎</span> GAS TRACKER
            </h1>
            <p className="dashboard-subtitle">Track how much gas your Supra wallet has spent.</p>
          </div>
        </header>
        ...
        <section className="dashboard-grid">
          <div className="dashboard-main-column">
            <section className="dashboard-panel">
              ...
              {/* HEADER REMOVED — GasFeeStats will render it */}
          ...
          <div className="dashboard-side-column">
            <section className="dashboard-panel">
              <div className="dashboard-panel-header">
                ...
                <span className="dashboard-panel-pill dashboard-pill-soon">Coming soon</span>
              </div>
              <div className="dashboard-panel-body dashboard-panel-placeholder">
                <p>Placeholder for a calendar-style heatmap showing wallet spikes.</p>
              </div>
            </section>
            ...
            <section className="dashboard-panel">
              ...
              <div className="dashboard-panel-body dashboard-panel-placeholder">
                <p>Planned metrics for RAWRpack holder tiers + comparisons.</p>
              </div>
            </section>
          </div>
        </section>
